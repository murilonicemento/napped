...
export function Image({ imageURL, title, type, description }: ImageProps) {
  return (
    <div className="relative -z-10">
      ...
      />
      <div className="w-full h-3/4 overflow-scroll absolute bottom-0 left-0 right-0 p-4 text-white bg-gradient-to-t to-gradient-image-to from-gradient-image-from">
